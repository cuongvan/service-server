...
class OneService(Resource):
    def get(self, service_name):
        ...
        if pending_services.service_is_being_removed(service_name):
    ...
    def delete(self, service_name):
        if not pending_services.new_removing_service(service_name):
            return { 'error': err.FUNCTION_NOT_FOUND }, http.NOT_FOUND
        ...
        try:
            ...
            pending_services.remove_service_done(service_name)
